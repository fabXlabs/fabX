...
<div class="relative container mt-7 max-w-(--breakpoint-2xl)">
	...
	<div class="my-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
		...
		<a href={resolve('/admin/qualification')}>
			<Card.Root>
				<Card.Header class="flex flex-row items-center justify-between space-y-0 pb-2">
	...
	<Button href={resolve('/admin/user/soft-deleted')} variant="outline" size="sm"
