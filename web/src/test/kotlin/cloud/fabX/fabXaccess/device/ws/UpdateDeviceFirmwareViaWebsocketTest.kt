...
internal class UpdateDeviceFirmwareViaWebsocketTest {
    ...
    private lateinit var testee: UpdateDeviceFirmwareViaWebsocket

    @Captor
    private lateinit var commandCaptor: ArgumentCaptor<UpdateDeviceFirmware>
    ...
    fun `configure WebModule`(
        ...
        testee = UpdateDeviceFirmwareViaWebsocket(deviceWebsocketController)
    }

    @Test
    fun `when updating device firmware then sends command and receives response`() = runTest {
        // given
        val deviceResponse = UpdateFirmwareResponse(4242)
        ...
        // when
        val result = testee.updateDeviceFirmware(deviceId, correlationId)
    ...
    @Test
    fun `given error while setting up receiving response when updating device firmware then returns error`() = runTest {
        // given
    ...
    @Test
    fun `given error while sending command when updating device firmware then returns error`() = runTest {
        // given
    ...
    @Test
    fun `given error while receiving response when updating device firmware then returns error`() = runTest {
        // given
    ...
    @Test
    fun `given unexpected response when updating device firmware then returns error`() = runTest {
        // given
