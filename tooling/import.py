...
# SETUP
# TODO reset to sample url
baseUrlOld = "https://fablab-muenchen-1.fabx.cloud/api/v1"
basicOld = HTTPBasicAuth("sschaeffner", "mGcuYUyQ6uhkeNZnpx")

# TODO reset to sample url
baseUrlNew = "http://localhost:8080/api/v1"
